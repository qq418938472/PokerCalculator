...
var SetOmahaCardPower = (function () {
    function SetOmahaCardPower() {
        this.cardCodes = new Array;
        this.handCodes = new Array;
        this.boardsCodes = new Array;
        this.table = new CardEvaluationTables;
        this.VSHIFT = 24;
        this.MAJOR_SHIFT = 20;
        this.MINOR_SHIFT = 16;
        this.flushRankMask = new Array;
    }
    SetOmahaCardPower.prototype.initCardPower = function (handCards, boards) {
    ...
    SetOmahaCardPower.prototype.changeCardsCode = function (cards, cardCodes) {
        cardCodes[0] = 0;
        cardCodes[1] = 0;
        cardCodes[2] = 0;
        cardCodes[3] = 0;
        for (var i = 0; i < cards.length; i++) {
            cardCodes[cards[i].color - 1] |= (1 << (cards[i].value - 2));
        }
    };
    //把手牌以及公共牌拼接起来
    SetOmahaCardPower.prototype.setAllCardCodes = function () {
        this.cardCodes[0] = 0;
        this.cardCodes[1] = 0;
        this.cardCodes[2] = 0;
        this.cardCodes[3] = 0;
    ...
    SetOmahaCardPower.prototype.setCardPower = function () {
        // d方块，c梅花，h红心，s黑桃
    ...
    SetOmahaCardPower.prototype.flushCheck = function () {
        var flushIndex = -1;
        for (var i = 0; i < this.cardCodes.length; i++) {
    ...
    SetOmahaCardPower.prototype.straightCheck = function (rankmask) {
        var topind = this.table.straightTable[rankmask];
        if (topind > 0) {
            var straghtRankMask = topind == 3 ? 4111 : this.table.topFiveRanksTable[(1 << topind + 1) - 1];
    ...
    SetOmahaCardPower.prototype.fourKindCheck = function (rankmask) {
        var topind = -1;
        var botind = -1;
    ...
    SetOmahaCardPower.prototype.fullHouseCheck = function (rankmask) {
        var topind = this.table.topRankTable[rankmask];
        if (topind >= 0) {
            var handCount = this.getCardsNumById(this.handCodes, topind);
            var boardCount = this.getCardsNumById(this.boardsCodes, topind);
    ...
    SetOmahaCardPower.prototype.getPairMask = function (cardCodes, topind) {
        var d = cardCodes[0];
        var c = cardCodes[1];
        var h = cardCodes[2];
        var s = cardCodes[3];
    ...
    SetOmahaCardPower.prototype.getPair = function (pairRankMask, type) {
    ...
    SetOmahaCardPower.prototype.threeKindCheck = function (rankmask) {
        var topind = this.table.topRankTable[rankmask];
        if (topind >= 0) {
            var handCount = this.getCardsNumById(this.handCodes, topind);
            var boardCount = this.getCardsNumById(this.boardsCodes, topind);
    ...
    SetOmahaCardPower.prototype.twoPairCheck = function (rankmask) {
    ...
    SetOmahaCardPower.prototype.botPairWithHightCard = function (pairRankMask, type, topPair) {
    ...
    SetOmahaCardPower.prototype.hightCardCheck = function (rankmask, topPair, botPair) {
    ...
    SetOmahaCardPower.prototype.onePairCheck = function (rankmask) {
    ...
    SetOmahaCardPower.prototype.hightCardsCheck = function () {
    ...
    SetOmahaCardPower.prototype.getCardsNumById = function (cardCodes, topind) {
        var count = 0;
    ...
    // 用4个值代表4个花色下的所有牌信息
    SetOmahaCardPower.ins = new SetOmahaCardPower;
    return SetOmahaCardPower;
}());
__reflect(SetOmahaCardPower.prototype, "SetOmahaCardPower");
//# sourceMappingURL=SetOmahaCardPower.js.map