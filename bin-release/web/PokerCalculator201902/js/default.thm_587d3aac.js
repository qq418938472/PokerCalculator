window.skins={};
	...
	function HomePageSkin() {
		_super.call(this);
		this.skinParts = ["g_common","btn_add","g_playerList","g_scroller","btn_calculate","btn_clear","tips"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this._Image1_i(),this._Rect1_i(),this._Rect2_i(),this.g_common_i(),this.g_scroller_i(),this.btn_calculate_i(),this.btn_clear_i(),this.tips_i()];
	}
